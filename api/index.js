...
app.get('/zhuce', function(req, res) {
    ...
    fs.readFile("log.txt", function(err, data) {
        var content = data.toString() + req.query.phonenumber + "  " + req.query.password + " ";
    ...
    http.request({
        hostname: 'localhost',
        port: '80',
        path: '/project3/6.20/6.26/api/reg.php?phonenumber=' + req.query.phonenumber + '&password=' + req.query.password,
        method: 'GET'
    }, function(aaa) {
        aaa.setEncoding('utf8');
        var data = "";
        aaa.on('data', function(chunk) {
            data += chunk
        });
        aaa.on('end', function() {
            console.log(data);
...
app.get('/denglu',function(req, res){
 ...
 //    })
    ...
    http.request({
        hostname: 'localhost',
        port: '80',
        path: '/project3/6.20/6.26/api/login.php?phonenumber=' + req.query.phonenumber + '&password=' + req.query.password,
        method: 'GET'
    }, function(aaa) {
        aaa.setEncoding('utf8');
        var data = "";
